...
In order to support loading of multiple wallets in cryptogreen-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptogreen.cpp.
...
Changes to cryptogreen.cpp
----------------------
cryptogreen.cpp is the entry point into cryptogreen-qt, and as such, will require some minor modifications to provide hooks for
