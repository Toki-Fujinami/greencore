Contributing to Cryptogreen Core
============================

The Cryptogreen Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cryptogreen Core project, and is not to be
confused with overall Cryptogreen Network Protocol consensus changes.

Whether a pull request is merged into Cryptogreen Core rests with the project merge
...
Patches that change Cryptogreen consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cryptogreen consensus, it must have been
...
The project leader is the release manager for each Cryptogreen Core release.
