...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/cryptogreen-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cryptogreen-cli.cpp \
           src/cryptogreen-tx.cpp \
           src/cryptogreen.cpp \
           src/db.cpp \
           ...
           src/qt/cryptogreen.cpp \
           src/qt/cryptogreenstrings.cpp \
...
RESOURCES += src/qt/cryptogreen.qrc src/qt/cryptogreen_locale.qrc

TRANSLATIONS += src/qt/locale/cryptogreen_bg.ts \
                src/qt/locale/cryptogreen_de.ts \
                src/qt/locale/cryptogreen_en.ts \
                src/qt/locale/cryptogreen_es.ts \
                src/qt/locale/cryptogreen_fi.ts \
                src/qt/locale/cryptogreen_fr.ts \
                src/qt/locale/cryptogreen_it.ts \
                src/qt/locale/cryptogreen_ja.ts \
                src/qt/locale/cryptogreen_pl.ts \
                src/qt/locale/cryptogreen_pt.ts \
                src/qt/locale/cryptogreen_ru.ts \
                src/qt/locale/cryptogreen_sk.ts \
                src/qt/locale/cryptogreen_sv.ts \
                src/qt/locale/cryptogreen_vi.ts \
                src/qt/locale/cryptogreen_zh_CN.ts \
                src/qt/locale/cryptogreen_zh_TW.ts
