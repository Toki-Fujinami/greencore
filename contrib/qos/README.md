...
This means one can have an always-on cryptogreend instance running, and another local cryptogreend/cryptogreen-qt instance which connects to this node and receives blocks from it.
