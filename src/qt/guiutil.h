...
/** Utility functions used by the Cryptogreen Qt UI.
 */
namespace GUIUtil
{
...
// Render Cryptogreen addresses in monospace font
...
// Parse "cryptogreen:" URI into recipient object, return true on successful parsing
