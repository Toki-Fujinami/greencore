...
public:
    ...
    void setZCryptogreenControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzGREEN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzGREEN_clicked();
    void on_pushButtonZCryptogreenControl_clicked();
