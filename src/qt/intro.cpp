...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cryptogreen Core"),
     ...
     * override -datadir in the cryptogreen.conf file in the default data directory
     * (to be consistent with cryptogreend behavior)
     */
    if (dataDir != getDefaultDataDirectory())
