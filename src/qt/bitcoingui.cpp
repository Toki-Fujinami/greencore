                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cryptogreen Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cryptogreen address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptogreen: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGREEN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cryptogreen Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cryptogreen Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cryptogreen"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cryptogreen addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cryptogreen addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cryptogreen: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cryptogreen Core help message to get a list with possible Cryptogreen command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cryptogreen Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cryptogreen network", "", count));
}
...
{
    QString strTitle = tr("Cryptogreen Core"); // default title
