                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Cryptogreen from zCryptogreen"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCryptogreen"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCryptogreen));
