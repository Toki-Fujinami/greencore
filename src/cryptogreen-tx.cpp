...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cryptogreen Core cryptogreen-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptogreen-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptogreen transaction") + "\n" +
                               "  cryptogreen-tx [options] -create [commands]   " + _("Create hex-encoded cryptogreen transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptogreen transaction
