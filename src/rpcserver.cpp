...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Cryptogreen server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Cryptogreen server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cryptogreen features */
        {"cryptogreen", "masternode", &masternode, true, true, false},
        {"cryptogreen", "listmasternodes", &listmasternodes, true, true, false},
        {"cryptogreen", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cryptogreen", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cryptogreen", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cryptogreen", "masternodedebug", &masternodedebug, true, true, false},
        {"cryptogreen", "startmasternode", &startmasternode, true, true, false},
        {"cryptogreen", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cryptogreen", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cryptogreen", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cryptogreen", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cryptogreen", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cryptogreen", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cryptogreen", "mnbudget", &mnbudget, true, true, false},
        {"cryptogreen", "preparebudget", &preparebudget, true, true, false},
        {"cryptogreen", "submitbudget", &submitbudget, true, true, false},
        {"cryptogreen", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cryptogreen", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cryptogreen", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cryptogreen", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cryptogreen", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cryptogreen", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cryptogreen", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cryptogreen", "checkbudgets", &checkbudgets, true, true, false},
        {"cryptogreen", "mnsync", &mnsync, true, true, false},
        {"cryptogreen", "spork", &spork, true, true, false},
        {"cryptogreen", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cryptogreen", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cryptogreend, or the -server option to cryptogreen-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cryptogreen-cli " + methodname + " " + args + "\n";
}
