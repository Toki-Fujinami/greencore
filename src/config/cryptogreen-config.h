/* src/config/cryptogreen-config.h.  Generated from cryptogreen-config.h.in by configure.  */
/* src/config/cryptogreen-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GREENUR_CONFIG_H

#define GREENUR_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.cryptogreen.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cryptogreen Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cryptogreen Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cryptogreen"
